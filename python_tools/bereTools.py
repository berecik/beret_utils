...
anonim_div = lambda a, b: ( int( a ) / int( b ), ( a % b ) / (lambda a, b: ( lambda g: ( lambda f: g( lambda *arg: f( f )( *arg ) ) ) ( lambda f: g( lambda *arg: f( f )( *arg ) ) ) )( lambda f: lambda a, b: not b and a or f( b, a % b ) )( a, b ))( ( a % b ), b ), b / (lambda a, b: ( lambda g: ( lambda f: g( lambda *arg: f( f )( *arg ) ) ) ( lambda f: g( lambda *arg: f( f )( *arg ) ) ) )( lambda f: lambda a, b: not b and a or f( b, a % b ) )( a, b ))( ( a % b ), b ) )
...
base_encoding = lambda x: Y(lambda f: lambda x, ret: f(x//len(A), "%s%s" % (ret,A[x%len(A)])) if x >= len(A) else "%s%s" % (ret,A[x]))(x, "")
